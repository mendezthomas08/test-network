...
const instantiateChaincode = async function(peers, channelName, chaincodeName, chaincodeVersion, functionName, chaincodeType, args, username, org_name, policy) {
	...
	try {
		...
		let results = await channel.sendInstantiateProposal(request, 600000); 
